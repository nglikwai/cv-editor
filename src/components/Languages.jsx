...
export const Languages = ({ languages, updateField }) => {
  ...
  return (
    <div className="cv-section cv-languages py-4 px-8">
      ...
      <div className="cv-configurable-text cv-text-large flex flex-wrap gap-x-6 gap-y-2 text-base">
          ...
          <div key={index} className="flex items-center gap-1.5">
            <span className="font-semibold text-deep-blue uppercase tracking-wide">
              <EditableInput
                ...
                className="cv-configurable-text cv-text-large font-semibold text-base w-auto min-w-10 uppercase tracking-wide"
              />
            </span>
            ...
            <span className="text-text-light italic">
              <EditableInput
                ...
                className="cv-configurable-text cv-text-large text-base w-auto min-w-10 italic"
              />
            </span>
          </div>
        ))}
