    ...
    <div className="cv-section py-4 px-8">
      ...
      <div className="space-y-2">
        {itemsToRender.map((cert, index) => (
          <div key={index} className={`cv-configurable-text cv-text-large flex justify-between items-center text-base py-1.5 px-2 bg-bg-light rounded${index >= certifications.length ? ' print:hidden' : ''}`}>
